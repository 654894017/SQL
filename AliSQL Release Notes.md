...
Default                 6
Descirbe                Compression level used for compress-format column.  0 is no compression
...
queries(up to 'rds_threads_running_ctl_mode'), will be rejected, i.e. an error will be returned to client.
